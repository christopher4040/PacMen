...
function update() {
    ...
    pacMen.forEach((item) => {
        ...
        item.newimg.mouthPosition = (item.newimg.mouthPosition + 1) % 2;
        if (item.velocity.x > 0) item.newimg.src = pacArray[0][item.newimg.mouthPosition];
        else item.newimg.src = pacArray[1][item.newimg.mouthPosition];
